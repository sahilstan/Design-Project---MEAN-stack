...
public class ImageAdapter extends RecyclerView.Adapter <ImageAdapter.ImageViewHolder>{
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        Picasso.with(mContext).load(uploadCurrent.getmImageUrl()).placeholder(R.drawable.logo).fit().centerCrop().into(holder.imageView);
    }
    ...
    , MenuItem.OnMenuItemClickListener{
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            MenuItem doWhatever = menu.add(Menu.NONE, 1, 1, "Notify Students");
            ...
            if(mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    ...
                    switch (item.getItemId()){
                        case 1:
                            mListener.NotifyClick(position);
                            return true;
                        case 2:
